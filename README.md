[![Build Status](https://dev.azure.com/thabo-org/learning-az-devops/_apis/build/status%2FThaboKalima.python-sample-vscode-flask-tutorial?branchName=main)](https://dev.azure.com/thabo-org/learning-az-devops/_build/latest?definitionId=1&branchName=main)
